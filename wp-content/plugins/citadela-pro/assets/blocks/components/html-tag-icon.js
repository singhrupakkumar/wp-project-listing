...
export default function HtmlTagIcon( { level, isPressed = false } ) {
	const levelToPath = {
		p:	'M5.7,6.1h2.2v1.3C8.2,7,8.6,6.6,9,6.3c0.5-0.3,1-0.4,1.6-0.4c1,0,1.9,0.4,2.6,1.2c0.7,0.8,1.1,1.9,1.1,3.4s-0.4,2.6-1.1,3.4c-0.7,0.8-1.6,1.2-2.6,1.2c-0.5,0-0.9-0.1-1.3-0.3c-0.4-0.2-0.8-0.5-1.3-1v4.4H5.7V6.1z M8,10.3c0,1,0.2,1.7,0.6,2.2C9,13,9.5,13.2,10,13.2s1-0.2,1.4-0.7c0.4-0.4,0.5-1.1,0.5-2.1c0-0.9-0.2-1.6-0.6-2.1s-0.8-0.7-1.4-0.7c-0.6,0-1,0.2-1.4,0.7C8.2,8.8,8,9.5,8,10.3z',
