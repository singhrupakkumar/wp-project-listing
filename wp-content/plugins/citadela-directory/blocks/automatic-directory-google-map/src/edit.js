...
export default class Edit extends Component {
    ...
    render() {
        ...
        const isItemDetail = editPageId === itemDetailPageId;
        ...
        return (
            <>
                <InspectorControls key='inspector'>
                    ...
                    >
                        ...
                        <SelectControl
                            ...
                            onChange={ ( value ) => { setAttributes( { noDataBehavior: value } ) } }
                        />

                        { noDataBehavior == 'empty-map' &&
                            <TextControl
                ...
                <div className={ classNames(
                        "wp-block-citadela-blocks ctdl-automatic-directory-google-map",
