...
export default class ResponsiveOptionsTabs extends Component {
	...
	render() {
		...
		let tabLabel = activeTab == "desktop"
			? __( 'General options for desktop.', 'citadela-directory')
			: __( 'Customized options for mobile screen width.', 'citadela-directory');
					...
					<div class="responsive-tabs">
						<div className={ classNames( "desktop-tab", { "active": activeTab === "desktop" } ) }>
							<Button
								...
								icon={ icons.desktop }
								label={ __("Desktop size", "citadela-directory") }
						...
						<div className={ classNames( "mobile-tab", { "active": activeTab === "mobile" } ) }>
							<Button
								...
								icon={ icons.mobile }
								label={ __("Mobile size", "citadela-directory") }
