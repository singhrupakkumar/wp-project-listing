...
registerBlockType( name, { ...metadata, 
	title: __( "Item GPX Download", 'citadela-directory' ),
	description: __( "Displays button to download GPX file assigned to item.", 'citadela-directory' ),
			...
			<div className={ classNames(
				...
				<div 
					...
					<RichText
						...
						placeholder={ __('Download GPX file', 'citadela-directory') }
						value={ text }
